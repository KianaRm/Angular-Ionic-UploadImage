...
export class HomePage {
  ...
  async loadFiles(){
    ...
    Filesystem.readdir({
      ...
      //this.loadFileData(sonuc);
      this.loadFileData(sonuc.files.map(x=>x.name));
     // const fileNames = sonuc.files.map(fileInfo => fileInfo.name);
  ...
  convertBlobBase64 = (blob:Blob) => new  Promise((resolve,reject) =>{
